...
class Mac2Driver extends BaseDriver {
  ...
  async setSystemProxy() {
    // TODO: This must be behind a security flag. Potentially this requires 'sudo'
    // Set system proxy as 'proxy' capabilities
    // https://www.w3.org/TR/webdriver1/#proxy
    // 'proxy'
    //  'ftpProxy', 'httpProxy', 'noProxy', 'sslProxy', 'socksProxy'
    // How: 'networksetup' command
